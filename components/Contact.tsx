...
const socials = [
  {
    ...
    valueClassName: "text-[clamp(1.28rem,1.7vw,1.9rem)] leading-[0.98] break-all md:break-normal",
    icon: (
  ...
  },
  {
    ...
    valueClassName: "text-[clamp(1.2rem,1.45vw,1.72rem)] leading-[0.98] break-words md:break-normal",
    icon: (
  ...
  },
  {
    ...
    valueClassName: "text-[clamp(1.15rem,1.4vw,1.65rem)] leading-[0.98] break-words md:break-normal",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    valueClassName: "text-[clamp(1.15rem,1.35vw,1.62rem)] leading-[0.98] break-words md:break-normal",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
const layoutClasses = [
  "sm:col-span-2 lg:min-w-0 lg:flex-[1.85] lg:hover:flex-[2.15]",
  "lg:min-w-0 lg:flex-[1] lg:hover:flex-[1.14]",
  "lg:min-w-0 lg:flex-[1] lg:hover:flex-[1.14]",
  "lg:min-w-0 lg:flex-[1] lg:hover:flex-[1.14]",
];
  ...
  return (
    <footer id="contact" className="px-6 pb-12 pt-28 sm:px-10 lg:px-16 lg:pt-40">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <h2 className="display mt-6 max-w-4xl text-4xl font-medium leading-[0.97] tracking-tight sm:text-6xl lg:text-7xl">
        ...
        <div className="mt-20 grid gap-4 border-t border-ink/10 pt-10 sm:grid-cols-2 lg:flex lg:items-stretch">
          {socials.map((s, i) => (
            <Reveal
              key={s.label}
              index={i % 4}
              className={`${layoutClasses[i]} transition-[flex-grow] duration-700 ease-apple`}
            >
              <a
                href={s.href}
                ...
                data-cursor="hover"
                className="group relative flex h-full min-h-[220px] min-w-0 flex-col overflow-hidden border border-ink/10 bg-paper p-6 transition-[border-color,background-color] duration-500 ease-apple hover:border-ink/20"
              ...
              >
                ...
                <div className="relative z-10 flex items-center justify-between gap-6">
                  ...
                  <div className="flex shrink-0 items-center gap-3 text-xs uppercase tracking-[0.16em] text-ink/40">
                    <span>{s.label}</span>
                    <span className="text-ink/30 transition-all duration-500 ease-apple group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-ink">
                      ↗
                    </span>
                  </div>
                </div>
                ...
                <div className="relative z-10 mt-auto min-w-0">
                  <p className={`max-w-full min-w-0 font-medium tracking-tight text-ink ${s.valueClassName}`}>
                    {s.value}
                  </p>
                  <p className="mt-3 max-w-sm text-sm leading-relaxed text-ink/50">{s.note}</p>
                </div>
              </a>
            </Reveal>
          ))}
